...
title: 'Gravitational Field: Exploring Intercorporeality as Instruments within a Co-located Mixed Reality'
author:
  - name: Botao (Amber) Hu
    affiliation: Holo Interactive
    email: botao@holoi.com
  - name: Boxiong Zhao
    affiliation: China Academy of Art
    email: boxiong@caa.edu.cn
  - name: Chu Zhang
    affiliation: China Academy of Art
    email: chuzhang@caa.edu.cn
abstract: |
...
International Conference on Live Coding 2024.
...
iclc2024.md to see the source of this document, and iclc2024.pdf to
see the typeset output. Use of this template is currently only
recommended for those familiar with commandline tools.

We suggest you take a copy of this template (iclc2024.md), and use it
...
If you have questions, you can email us directly:
  [shanghai.iclc24@nyu.edu](mailto:shanghai.iclc24@nyu.edu)
...
For a higher quality output, add the option `--pdf-engine=xelatex`
...
We look forward to receiving your completed papers. Submission is through CMT only, see https://iclc.toplap.org/2024/open-call.html. Do not send papers directly by e-mail. In all cases, please submit a PDF version of 
